...
import pt.khanh.com.orderfood.Database.Database;
import pt.khanh.com.orderfood.Model.Order;
import pt.khanh.com.orderfood.Model.Request;
import pt.khanh.com.orderfood.ViewHolder.CartAdapter;
...
public class Cart extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recyclerView = findViewById(R.id.rvListCart);
    ...
    private void showDialogPlaceOrder() {
        AlertDialog.Builder alertdialog = new AlertDialog.Builder(Cart.this);
        alertdialog.setTitle("One more step!");
        alertdialog.setMessage("Enter your address");
        final EditText edtAddr = new EditText(Cart.this);
        LinearLayout.LayoutParams layoutParams = new LinearLayout.LayoutParams(
                LinearLayout.LayoutParams.MATCH_PARENT,
                LinearLayout.LayoutParams.MATCH_PARENT
        );
        edtAddr.setLayoutParams(layoutParams);
        alertdialog.setView(edtAddr);
